...
import "./nav.scss";
const Nav = ({ setCurrentTheme, currentTheme }) => {
  const [navExp, setNavExp] = useState("noNavExp");
      ...
      <div className="nav_container">
        ...
        <div className="nav_container_links">
          <ul>
            ...
            <div
              onClick={() => {
                if (navExp === "noNavExp") setNavExp("navExp");
                else setNavExp("noNavExp");
              }}
            >
              <li>
                <svg
                ...
                <div className={"extension"}>
                  <li
                    className={currentTheme + " " + navExp + " li1"}
                    onClick={() => {
                      if (document.querySelector(".scenery").style.display === "none"){
                        document.querySelector(".scenery").style.display = "block";
                      }else{
                  ...
                  >
                    ...
                    <div className="tip">Scenery</div>
                  </li>
                  <li
                    className={currentTheme + " " + navExp + " li2"}
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className="tip">Tasks</div>
                  </li>
                  <li
                    className={currentTheme + " " + navExp + " li3"}
                    onClick={() => {
                      if (document.querySelector(".timer").style.display === "none"){
                  ...
                  <li
                    className={currentTheme + " " + navExp + " li4"}
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className="tip">Notes</div>
                  </li>
                  <li
                    className={currentTheme + " " + navExp + " li5"}
                    onClick={() => {
