...
import { setPagesOpen, setTheme } from "../../store/user";
          ...
          <ul>
            ...
            >
              <li>
                ...
                {navExp && <div className={"extension"}>
                  <li
                    className={userSettings.theme + " li1"}
                  ...
                  >
                    ...
                    <div className="tip text-sm">Scenery</div>
                  </li>
                  <li
                    className={userSettings.theme + " li2"}
                    style={{ padding: "10px", width: "max-content" }}
                    onClick={() => {
                      dispatch(setPagesOpen({
                        page: "calendar",
                  ...
                  >
                    ...
                    <div className="tip text-sm">Tasks</div>
                  </li>
                  <li
                    className={userSettings.theme + " li3"}
                    style={{ padding: "10px", width: "max-content" }}
                    onClick={() => {
                      dispatch(setPagesOpen({
                        page: "timer",
                  ...
                  >
                    ...
                    <div className="tip text-sm">Timer</div>
                  </li>
                  <li
                    className={userSettings.theme + " li4"}
                    style={{ padding: "10px", width: "max-content" }}
                    onClick={() => {
                      dispatch(setPagesOpen({
                        page: "notes",
                  ...
                  >
                    ...
                    <div className="tip text-sm">Notes</div>
                  </li>
                  <li
                    className={userSettings.theme + " li5"}
                    style={{ padding: "10px", width: "max-content" }}
                    onClick={() => {
                      dispatch(setPagesOpen({
                        page: "chat",
                  ...
                  >
                    ...
                    <div className="tip text-sm">Chat</div>
                  </li>
                </div>}
              </li>
            </div>
